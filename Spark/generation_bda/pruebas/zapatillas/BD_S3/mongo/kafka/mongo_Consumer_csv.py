...
query = df \
    ...
    .outputMode("append") \
    .format("csv") \
    .option("path", "s3a://my-local-bucket/mongo_zapatillasConsumer_csv") \
    .option("checkpointLocation", "s3a://my-local-bucket/mongo_zapatillasConsumer_csv")\
    .option("header", "true")\
